...
smoke100 = st.selectbox("Smoked ≥100 cigarettes in life?", [("Yes", 1), ("No", 0)])[1]
...
if st.button("Predict Cardiovascular Risk"):
    ...
    if prediction == 1:
        st.error("⚠️ **High Risk:** Consult a healthcare professional immediately.")
    else:
        st.success("✅ **Low Risk:** No immediate cardiovascular disease risk detected.")